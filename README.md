...
* **Geographic Distribution:** Research volume was heavily concentrated in the U.S., France, and the UK, which together account nearly for 40% of clinical initiatives.
...
|             ├── duration_condition.png
|             ├── duration_vs_enroll.png
|             ├── duration_vs_phase_1.png
|             ├── duration_vs_phase_2.png
|             ├── enroll_boxplot.png
...
|             └── total_studies_Interv vs Obs.png
├── MySQL schema/
|        ├── Covid19_db.sql
|        └── SQL Queries.sql
├── README.md
